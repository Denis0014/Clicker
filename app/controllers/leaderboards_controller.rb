class LeaderboardsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to leaderboards_path, status: :see_other, notice: "Leaderboard was successfully destroyed." }
  ...
  private
    ...
    def set_leaderboard
      @leaderboard = Leaderboard.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def leaderboard_params
      params.expect(leaderboard: [ :user, :score ])
    end
end
